...
public class ColorUtils {
    ...
    // Format Text
    public static String replacePlaceholders(String text, Player sender, Player target) {

        text = text.replaceAll("%player%", sender.getName());
        text = text.replaceAll("%target%", target.getName());
